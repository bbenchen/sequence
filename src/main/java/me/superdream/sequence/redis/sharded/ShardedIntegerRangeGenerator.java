 ...
 * @since 0.1.0
 */
public class ShardedIntegerRangeGenerator extends AbstractIntegerRangeGenerator {
    private final ShardedJedisPool shardedJedisPool; // Redis的分片客户端实例

    public ShardedIntegerRangeGenerator(ShardedJedisPool shardedJedisPool, String hname, String hkey, int step) {
