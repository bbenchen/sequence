 ...
 * @since 0.1.0
 */
public class ShardedLongGenerator extends AbstractGenerator<Long> {
    private final ShardedJedisPool shardedJedisPool; // Redis的分片客户端实例

    public ShardedLongGenerator(ShardedJedisPool shardedJedisPool, String hname, String hkey) {
        super(hname, hkey);
