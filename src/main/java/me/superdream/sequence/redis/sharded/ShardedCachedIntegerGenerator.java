 ...
 * @since 0.1.0
 */
public class ShardedCachedIntegerGenerator extends AbstractCachedIntegerGenerator {
    private final ShardedJedisPool shardedJedisPool; // Redis的分片客户端实例

    public ShardedCachedIntegerGenerator(ShardedJedisPool shardedJedisPool, String hname, String hkey, int cachedNum) {
