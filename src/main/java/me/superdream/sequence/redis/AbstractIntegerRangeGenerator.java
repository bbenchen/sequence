 ...
 * @since 0.1.0
 */
public abstract class AbstractIntegerRangeGenerator extends AbstractGenerator<Integer> {
    ...
    public AbstractIntegerRangeGenerator(String hname, String hkey, int step) {
        super(hname, hkey);
        this.step = step;
