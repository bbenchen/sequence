 ...
 * @since 0.1.0
 */
public class ClusterIntegerRangeGenerator extends AbstractIntegerRangeGenerator {
    private final JedisCluster jedisCluster; // Redis集群客户端实例

    public ClusterIntegerRangeGenerator(JedisCluster jedisCluster, String hname, String hkey, int step) {
